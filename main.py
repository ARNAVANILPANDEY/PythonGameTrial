...
background = pygame.image.load('space_background2.png')
...
playerImg = pygame.image.load('spaceshipblue.png')
playerX = 370
playerY = 480
playerX_change = 0
...
font = pygame.font.Font('UniformRegular.otf', 32)
textX = 10
textY = 10

over_font = pygame.font.Font('UniformRegular.otf', 128)
